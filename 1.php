...
<body style="background-color:black;color:antiquewhite">
    ...
    <center>
        <h1 style="color: cyan;">Vikas Hotel</h1>
        <div style="
         width: 51%;
    border-style: double;
    border-radius: 17px;
    border-color: blue;
    border-width: 7px;">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3682.616226420181!2d75.80520671496059!3d22.63080198515292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3962fbe1e4677e1d%3A0x9d36977f2add037d!2sVikas%20Sweets%20And%20Restaurant!5e0!3m2!1sen!2sin!4v1605863262182!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;border-radius:10px" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>

        </div>

        <div>
            <h2>About Hotel-:</h2>
            <p style="color:lime;">Vikas Sweets & Restaurant in Indore. Restaurants with Address, Contact Number, Photos, Maps. View Vikas Sweets & Restaurant, Indore on Justdial.

                Making way for a hearty meal is Vikas Sweets & Restaurant in Indore. Established in the year 1998, this place is synonymous with delicious food that can satiate all food cravings. It is home to some of the most appreciated cuisines. So as to be able to cater to a large number of diners, it occupies a favourable location at Rau. G 8, Sule Empire, By Pass Circle,OPPosite Yash Dhba,Ab Road,Rau-453331 is where one can visit the venue. Courtesy to this strategic location, foodies in and around the neighborhood can walk in to this eating house conveniently without facing any hassles related to commuting to this part of the city. It is one of the most sought after Restaurants in Rau. For people in other parts, the restaurant also has branches at other locations which include Malwa Mill Chouraha - Indore City, Semlia Chau - Indore City and can also be visited for an appetizing meal. This is a one of the renowned Restaurants in Indore.

                Vikas Sweets & Restaurant at Rau makes sure one has a great food experience by offering highly palatable food. The restaurant welcomes guests from 07:00 - 23:00 allowing diners to relish a scrumptious meal between the functional hours.The price range of the food at the restaurant ranges from 1. One can make their payment via Cash, Debit Cards, Cheques, Credit Card. This listing is also listed in Restaurants, Sweet Shops, Inexpensive Restaurants (Below Rs 500), Moderate Restaurants (Rs 500 To Rs 1000), Rasgulla Retailers, Sweet Retailers, Ladoo Retailers, Gulab Jamun Retailers. </p>
        </div>
        <div>
            <h2>Menu-</h2>
