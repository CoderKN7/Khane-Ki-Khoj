...
<body style="background-color:black;color:antiquewhite">
    ...
    <center>
        <h1 style="color: cyan;">Baba Kulfi house</h1>
        <div style="
         width: 51%;
    border-style: double;
    border-radius: 17px;
    border-color: blue;
    border-width: 7px;">
            <iframe src=" https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14729.70194348605!2d75.812324!3d22.6379194!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x80c541eaee83f7b6!2sBaba%20Kulfi%20House!5e0!3m2!1sen!2sin!4v1606391165614!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;border-radius:10px" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>

        </div>

        <div>
            <h2>About Hotel-:</h2>
            <p style="color:lime;">A perfect place for a sweet treat whenever in the neighbourhood is Baba Kulfi House at Rau, Indore. The brand was founded in the year 1984 with a small ice-cream joint. The response it received led to its successful journey, culminating in the establishment of a chain of ice-cream parlours all across the city. It is the brand's commitment to quality that has led to its success and made it a name to reckon with in the industry. Easily accessible to people of all age groups, this establishment is situated strategically at Ab Road in Rau, an area that is well-connected to other eminent parts of the city via numerous modes of public transport. Undoubtedly it is one of the Best Ice Cream Retailers in Rau, Indore. </p>
        </div>
        <div>
            <h2>Menu-</h2>
